  ...
  data() {
    ...
    return {
      addPoliceFrom: {
        ...
        user_effective: '',
        pwd_effective: '',
        user_effective_flag: true,
        pwd_effective_flag: true,
        startTime: '',
        endTime: ''
      },
      rules: {
        ...
        user_effective: [{ validator: checkUserEffective, trigger: 'blur' }],
        pwd_effective: [{ validator: checkPwdEffective, trigger: 'blur' }],
